        ...
        function checkBoxes(form) {
            for (var i = 0; i < form.elements.length; i++) {
                if (form.elements[i].value == "") {
                    ...
                    document.F1.publisherName.focus()
                    return false
                }
            }

            if (!isNaN(document.F1.publisherName.value)) {
                alert("Yayınevi adı değeri yalnızca rakamlardan oluşamaz.")
                document.F1.publisherName.value = ""
                document.F1.publisherName.focus()
                return false
            }
            if (!isNaN(document.F1.publisherAddress.value)) {
                alert("Yayınevi adresi değeri yalnızca rakamlardan oluşamaz.")
                document.F1.publisherAddress.value = ""
                document.F1.publisherAddress.focus()
                return false
            }
            ...
            <td valign="top">
              ...
              if(session.getAttribute("verifyControl")=="approvedStaff"){
                ...
                <form name=F1 onSubmit="return checkBoxes(this)"
                    ...
                    <tr>
                        <td><b>Yayınevi Adı: </b> <input type="text" name="publisherName" required
                                                         placeholder="Yayınevinin adını giriniz."/> <input type="submit"
                                                                                                           value="Ekle"/>
                        </td>
                    </tr>
                    <br></br>
                    <tr>
                        <td><b>Yayınevi Adresi: </b> <input type="text" name="publisherAddress" required
                                                            placeholder="Yayınevinin adresini giriniz."/> <input
                                type="reset"
                                value="Temizle">
                        </td>
                    </tr>
                    ...
                    <table height="0" cellspacing="5" cellpadding="10">
                        ...
                        <%
                                ...
                                out.print("<tr><th>Yayınevi Adı</th> <td><th>Yayınevi Adresi</th></td></tr>");
