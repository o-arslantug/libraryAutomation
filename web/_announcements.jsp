...
<div id="templatemo_content_wrapper">
    ...
    <div id="templatemo_content_edited">

        <div class="content_box_edited">
            ...
            <td valign="top">
                ...
                <form>
                    <table height="0" cellspacing="5" cellpadding="10">
                        ...
                        <div class="news_box">
                            <a href="#"><h3><%out.print(announcement.getAnnouncementTitle());%></h3></a>
                            <p class="post_info">Posted by <span><b> <%
                                out.print(announcement.getAnnouncementAnnouncer());%></b></span>
                                on <span><%out.print(announcement.getAnnouncementDate());%></span><br><%
                                    out.print(announcement.getAnnouncementDescription());%></p>
        ...
        <div class="content_box_bottom_edited"></div>
