        ...
        function checkBoxes(form) {
            for (var i = 0; i < form.elements.length; i++) {
                if (form.elements[i].value == "") {
                    ...
                    document.F1.translatorName.focus()
                    return false
                }
            }

            if (!isNaN(document.F1.translatorName.value)) {
                alert("Çevirmen adı değeri yalnızca rakamlardan oluşamaz.")
                document.F1.translatorName.value = ""
                document.F1.translatorName.focus()
                return false
            }
...
<div id="templatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div class="content_box">
            ...
            <td><b>Çevirmen Adı: </b> <input type="text" name="translatorName" required
                                             placeholder="Çevirmenin adını giriniz."/>
            ...
            <table height="0" cellspacing="5" cellpadding="10">
                ...
                <%
                        ...
                        out.print("<tr><th>Çevirmen Adı</th></tr>");
