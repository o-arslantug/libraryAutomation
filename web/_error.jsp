    ...
    <div id="templatemo_content">
        ...
        <div class="content_box">
            ...
            <td valign="top">
                ...
                <form>
                    <table height="0" border="0" cellspacing="10" cellpadding="8">


                        <br></br>

                        <h2>Bu sayfayı görüntüleme izniniz yok!</h2></br>
                        <h3><a href='_staff.jsp'><b>Buraya</b></a> tıklayarak yönetici girişi yapabilirsiniz.</h3></br>
                        <h3>Bunun bir hata olduğunu düşünüyorsanız <a href='_contactUs.jsp'><b>buraya</b></a> tıklayarak
                            bizimle iletişime geçebilirsiniz.</h3>
