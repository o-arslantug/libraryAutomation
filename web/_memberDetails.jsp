        ...
        function checkBoxes(form) {
            for (var i = 0; i < form.elements.length; i++) {
                if (form.elements[i].value == "") {
                    ...
                    document.F1.memberID.focus()
                    return false
                }
            }

            if (isNaN(document.F1.memberID.value)) {
                alert("ID değeri yalnızca rakamlardan oluşabilir.")
                document.F1.memberID.value = ""
                document.F1.memberID.focus()
                return false
            }
            return true
                    ...
                    <table height="0" cellspacing="5" cellpadding="10">
                        ...
                        <%
                            ...
                            try {
                                ...
                                PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM Uye");
                                ResultSet resultSet = preparedStatement.executeQuery();

                                out.print("<h2>Üye Detayları</h2>");
                                out.print("<h4><a href='_registerMember.jsp'><b>Buraya</b></a> tıklayarak üye ekleyebilir,<br>'Üye ID' değerini belirterek var olan üyeler üzerinde işlem yapabilirsiniz.</h4>");
                        %>

                        <tr><b>Üye ID: </b></tr>
                        <input type="text" name="memberID" required placeholder="ID giriniz."/><b> </b>
                        <input type="Submit" value="Sil" action="/worksOnMember" name="comingFrom"/><b> </b>
                        <input type="Submit" value="Düzenle" formaction="_updateMember.jsp"/>
